...
select codigo_inteiro,razao_social from cadastro.tb_fornecedor 
left join cadastro.tb_contato on(codigo_inteiro = id_fornecedor) where id_fornecedor is null; 
